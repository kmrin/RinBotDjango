...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('spam_filter_action', models.IntegerField(choices=[(0, 'Disabled'), (1, 'Warn'), (2, 'Kick')], validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(2)])),
                ('spam_filter_message', models.TextField(blank=True, null=True)),
                ('spam_filter_reason', models.TextField(blank=True, null=True)),
